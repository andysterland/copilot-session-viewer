...
const props = defineProps({
  ...
  formatTokens: { type: Function, default: () => {} },
  formatDuration: { type: Function, default: () => {} },
  formatCost: { type: Function, default: () => {} },
  totalTokens: { type: Number, default: 0 },
  totalRequests: { type: Number, default: 0 },
  totalModels: { type: Number, default: 0 },
  getDisplayUsageInputTokens: { type: Function, default: () => {} },
  getModelCacheHitRatio: { type: Function, default: () => {} },
  toolCallingSummary: { type: Array, default: () => [] },
  sessionTags: { type: Array, default: () => [] },
  tagsEditing: Boolean,
  editingTags: { type: Array, default: () => [] },
  tagInputValue: { type: String, default: '' },
  tagsError: { type: String, default: '' },
  showAutocomplete: Boolean,
  autocompleteOptions: { type: Array, default: () => [] },
  autocompleteSelectedIndex: { type: Number, default: -1 },
  getTagColor: { type: Function, default: () => {} }
})
